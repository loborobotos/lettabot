...
# Install Railway CMY v4.33.0 via direct tarball (bypasses install script GitHub API call).
# Binary is renamed to railway-bin; a wrapper script gates access by checking
# $AGENT_ID against $RAILWAY_ALLOLED_AGENTS CSV list.
